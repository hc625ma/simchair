...
//        uint8_t padding2 : 8;
		...
		//uint16_t leftStickX : 16;  // Each of the analog stick values can range from 0 to 255
//		uint16_t leftStickY : 16;  //  0 is fully left or up
//		uint16_t rightStickX : 16; //  255 is fully right or down 
//		uint16_t rightStickY : 16;
//		uint16_t rudder :16;
//		uint16_t throttle2 :16;//  128 is centered.
...
//    //Set the sticks to 128 - centered
    ...
    controllerData.dial = 128;
    controllerData.slider = 128;
    // And return the data!
